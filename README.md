...
https://docs.google.com/document/d/1QPhw-7TtzddDpOwcDg9kLCLcedTO3E7_GA7YkR0VTi8/edit?tab=t.0
...
The primary goal of the AI is to enable proactive alerts. If the forecasted temperature exceeds a configurable safety threshold, the system publishes a **"CRITICAL"** alert. This allows for intervention _before_ an issue occurs, moving from reactive to predictive monitoring.
